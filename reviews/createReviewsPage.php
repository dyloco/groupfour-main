  ...
  <div class="reviewCanvas col-md-6" style = "margin-bottom: 100px;">
    <main class="form-signin">
      <link rel="stylesheet" href="/groupfour-main/buttonstyle.css" />
          ...
          <div style="text-align: center">
            <h1 style="color: #004C89">Update Appraisal</h1>
          </div>
          <div style="text-align: center">
          ...
          <?php if ($qID != null){ ?>
            <?php for ($x = 0; $x <= 4; $x+=1) {?>
              <div>
                ...
                <input maxlength="80" type="text", value = "<?php echo "$questionsArray[$x]" ?>" , class="inputFields reviewInput" id="username" name=<?php echo "question".($x+1)?>>
              </div>
            <?php } ?>
            ...
            <?php }else { ?>
              <?php for ($x = 0; $x <= 4; $x+=1) {?>
                <div>
                  <label for="floatingInput"class="loginFont reviewLabel"><?php echo "Question"." ".($x+1)?></label>
                  <input maxlength="80" type="text", value = "" , class="inputFields reviewInput" id="username" name=<?php echo "question".($x+1)?> readonly>
                </div>
              <?php } ?>
            <?php } ?>
            ...
            <div>
                ...
                <input type="text" value="On a scale of one to five, how would you rate the workload you recieve? (1 = minimal, 5 = alot)"class="inputFields reviewInput" id="username" name=<?php echo "question6"?> readonly>
                <span> 
              </div>
              <div>
                <label for="floatingInput"class="loginFont reviewLabel"><?php echo "Question 7"?></label>
                <input type="text" value="On a scale of one to five, how competent are you with the task(s) given? (1 = not very Competent, 5 = Very Competent)"class="inputFields reviewInput" id="username" name=<?php echo "question7"?> readonly>
                <span> 
              </div>
              <div>
                <label for="floatingInput"class="loginFont reviewLabel"><?php echo "Question 8"?></label>
                <input type="text" value="<?php echo $questionsArray[7] ?>"class="inputFields reviewInput" id="username" name=<?php echo "question8"?> readonly>
                <span> 
              </div>



            <button class="w-50 btn btn-lg btn-primary" style="align: center" type="submit" name="submit" value="User Login">Update Appraisal</button>
          </div>
        </form>
    </main>
  </div>
